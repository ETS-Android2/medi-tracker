...
import com.gautam.medicinetime.AlarmReceiver;
    ...
    private View.OnClickListener setClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (!mPresenter.isMedicineExits(pill_name)) {
                ...
                user.put("Medicine_Name", pill_name);
                user.put("Date",dateString);
                user.put("DayOfWeekList",day);
                user.put("Med_Hour",hour+":"+minute);
                user.put("Dose_Unit",doseUnit);
                user.put("Dose_quantity",doseQuantity);
                user.put("AlarmTime",alarmId);
//                user.put("Minute",minute);
//                user.put("Dose",dose_quantity);
...
////
                    Intent intentnotification = new Intent(getActivity(), AlarmReceiver.class);
                    intentnotification.putExtra("notificationId",_id);
                    intentnotification.putExtra("todo",pill_name);
...
//
                    PendingIntent alarmIntent = PendingIntent.getBroadcast(getActivity(), id, intentnotification, PendingIntent.FLAG_UPDATE_CURRENT);
                    AlarmManager alarmManager1 = (AlarmManager) requireContext().getSystemService(ALARM_SERVICE);
                    ...
                    //Toast.makeText(getActivity(), ""+alarm_time, Toast.LENGTH_SHORT).show();
//
                    alarmManager1.setRepeating(AlarmManager.RTC_WAKEUP, alarm_time,AlarmManager.INTERVAL_DAY * 7, alarmIntent);
//                    Intent mainIntent = new Intent(getContext(), AddMedicineFragment.class);
//                    mainIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//                    PendingIntent contentIntent = PendingIntent.getActivity(getContext(), 22222, mainIntent,PendingIntent.FLAG_UPDATE_CURRENT);
