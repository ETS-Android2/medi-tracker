...
public class ClinicAppDrActivity extends AppCompatActivity {
    FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clinic_app_dr);
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    for (QueryDocumentSnapshot document : task.getResult()) {
                        ...
                        //Toast.makeText(ClinicAppDrActivity.this,"NAMES"+name,Toast.LENGTH_SHORT).show();
                        MyAdapter adapter = new MyAdapter(ClinicAppDrActivity.this, name, email,mo,time);
