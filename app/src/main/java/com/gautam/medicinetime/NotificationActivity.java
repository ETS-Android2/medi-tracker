...
public class NotificationActivity extends AppCompatActivity {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    for (QueryDocumentSnapshot document : task.getResult()) {
                        ...
                        dose12.add(document.getString("Dose"));
                        //mTitle = new String[]{document.getString("Clinic_Name"),document.getString("Clinic_Name")};

                        MyAdapter adapter = new MyAdapter(NotificationActivity.this, namelist, timelist,date23,dose12);
                    ...
                    Toast.makeText(NotificationActivity.this,""+task.getException(),Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    class MyAdapter extends ArrayAdapter<String> {
        ...
        MyAdapter (Context c, List<String> title, List<String> username,List<String> date11, List<String> dose1) {
            super(c, R.layout.notification_view, R.id.textView1, title);
            this.context = c;
            this.rTitle = title;
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            View row = layoutInflater.inflate(R.layout.notification_view, parent, false);
